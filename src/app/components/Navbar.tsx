...
const Navbar = () => {
  ...
  return (
    ...
    <div className =" bg-gray-800 text-white p-2 flex ">
      ...
      <button onClick={toggleMenu}className=" right: 0 md:hidden p-2 bg-gray-700 rounded px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">=</button>
      {isOpen && (
